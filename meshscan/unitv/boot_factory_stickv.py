# boot_factory_stickv.py
# BACKUP of the M5StickV factory /flash/boot.py that shipped on this K210
# (captured 2026-06-16 before replacing it with the MeshScan launcher).
# This is the StickV face-detection demo. It crashes on Unit V hardware at
# `pmu = axp192()` (no AXP192 PMU). Kept here so the original can be restored.
